...
import { BookingTrendSparkline } from '@/features/dashboard/components/BookingTrendSparkline';
import { computeBookingTrend, computeWeeklyVolume } from '@/features/dashboard/utils/dashboardMetrics';
...
export function PwaSalesDashboard() {
