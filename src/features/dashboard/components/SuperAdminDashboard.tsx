...
import { UserStatusRing } from './UserStatusRing';
import { AdminSessionTimeline } from './AdminSessionTimeline';
import { SessionStatusDonut } from './charts/SessionStatusDonut';
import { WeeklySessionsChart } from './charts/WeeklySessionsChart';
import { RoleBreakdownChart } from './charts/RoleBreakdownChart';
...
export function SuperAdminDashboard() {
  ...
  return (
    <BentoGrid>
      ...
      <StatTile
        id="tour-stat-pending-signups"
        className={bentoStyles.span2}
        label={t('SuperAdminDashboard.pendingSignups')}
        value={pendingCount}
        icon={ShieldAlert}
        tone="warning"
      />
      <StatTile
        id="tour-stat-deactivated"
        className={bentoStyles.span2}
        label={t('SuperAdminDashboard.deactivated')}
      ...
      <StatTile
        ...
        className={bentoStyles.lgSpan6}
        label={t('SuperAdminDashboard.totalSessions')}
